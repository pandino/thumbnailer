-- Archive current movie via Movie Thumbnailer API (Native HTTP Version)
...
local function make_api_request(filename, callback)
    msg.info("Making API request to archive: " .. filename .. " (using " .. http_method .. ")")
...
msg.info("Native HTTP archive script loaded (" .. http_method .. "). Use 'script-message archive-movie' to archive current movie.")
